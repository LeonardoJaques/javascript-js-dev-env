/* This file contains references to the vendor libraries
   ...
   one of them change. So basically, this avoids customers
   having downloads a huge JS file any time a line of code changes.
   The only have to download vendor.js when a vendor library changes
   which should be less frequent.
   Any files that aren't referenced here will be bundle into main.js for
